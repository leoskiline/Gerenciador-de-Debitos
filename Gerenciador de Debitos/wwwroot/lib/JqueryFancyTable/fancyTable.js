		...
		this.each(function() {
			...
			if(settings.searchable){
				...
				if(settings.globalSearch){
					...
					var th = $("<th>",{ style:"padding:10px;" }).attr("colspan",elm.fancyTable.nColumns);
					...
					$(elm).find("td").first().parent().find("td").each(function() {
						...
						var searchField = $("<input>",{
							...
							style:"width:100%;border:1px solid lightgray;border-radius:4px;padding:7px;"+settings.inputStyle
						}).bind("change paste keyup",function(){
						...
						n++;
						if (n == 0) {
							settings.inputPlaceholder = "Descricao...";
						} else if (n == 1) {
							settings.inputPlaceholder = "19-12-2000...";
						}
						else if (n == 2) {
							settings.inputPlaceholder = "Filtrar Valor...";
						}
